...
from stationeryapp import views
...
urlpatterns = [
    ...
    path("penlistview/", views.penlistview, name="penlistview"),
    path("notebooklistview/", views.notebooklistview, name="notebooklistview"),
    path("Calculatorlistview/", views.calculatorlistview, name="Calculatorlistview"),
    path("otherProductlistview/", views.otherProductlistview, name="otherProductlistview"),
